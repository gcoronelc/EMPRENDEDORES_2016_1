...
constraint chkVentasImporte check(Importe = (PrecioVenta * Cantidad))
);
go
...
INSERT INTO VENTAS(NroVenta,fecha,cliente,DirCliente,ProductoId,PrecioVenta,Cantidad,Importe)
VALUES(200,'30-JULIO-2016','JUAN CARDENAS ','AV LAS FLORES 194',2,2.50,100,250);
GO
...
INSERT INTO VENTAS(NroVenta,fecha,cliente,DirCliente,ProductoId,PrecioVenta,Cantidad,Importe)
VALUES(115,'21-AGOSTO-2016','JUAN PACHECO','AV CERCA DE MI CASAS 1213',4,5.00,136,680.00);
GO
...
select NomProducto,PrecioLista 
from TBDPC4.dbo.PRODUCTO;
go 

----pregunta 2

select  NroVenta, fecha, cliente, Importe 
from TBDPC4.dbo.VENTAS
...
select NroVenta,fecha,ProductoId,Cantidad,Importe 
from TBDPC4.dbo.VENTAS
where ProductoId = 3;
go
...
select cliente, NroVenta, Importe 
from TBDPC4.dbo.VENTAS
...
select  NroVenta,cliente,DirCliente,Importe 
from TBDPC4.dbo.VENTAS
where Importe > 500 
AND (DirCliente='AV DOMINICOS 235' OR DirCliente='AV LAS FLORES 194');
GO

-- PREGUNTA 6

SELECT NroVenta,cliente,PrecioVenta,Cantidad,Importe 
FROM TBDPC4.dbo.VENTAS
where cliente like '_[aeu]%' 
and (Cantidad >=10 and Cantidad <=20);

SELECT NroVenta,cliente,PrecioVenta,Cantidad,Importe 
FROM TBDPC4.dbo.VENTAS
where cliente like '_[aeu]%' 
and (Cantidad between 10 and 20);
